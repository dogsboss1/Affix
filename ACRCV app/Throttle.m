...
#define kThumbSpringsBackDuration .3

@interface Throttle (private)
...
- (void) resetVelocity {
    isTracking = NO;
    velocity = CGPointZero;
    SKAction *easeOut = [SKAction moveTo:self.anchorPointInPoints duration:kThumbSpringsBackDuration];
